export const QUESTIONS_LABLES = [
  ...
  // "Je porte des lunettes de soleil / plisse les yeux / me bouche le nez ou les oreilles / me gratte dans des vêtements non confortables",
  // "J’ai besoin de solitude régulière pour garder ou retrouver votre équilibre émotionnel surtout après un environnement stimulant",
  ...
  // "J’étouffe lorsque c’est l’effervescence autour de moi et supporte mal la foule",
  ...
  // "Je passe du temps à réfléchir sur mes expériences ou à anticiper les conséquences possibles de mes choix",
  ...
  // "La faim provoque en moi une réaction et perturbe ma concentration et mon humeur",
  // "Lorsque l'on m'observe pendant que je travaille, je perds mon sang-froid et j'obtiens un résultat bien pire que lorsqu'on me laisse tranquille",
  ...
  // "Ma capacité d’empathie est si forte que je ressens les émotions des autres alors que je ne suis pas concerné(e) par le sujet",
  // "Lorsque les autres se sentent mal à l'aise dans leur environnement matériel, je sens en général ce que je dois faire pour les soulager (changer l'éclairage, proposer d'autres sièges, ouvrir une fenêtre)",
  // "Je suis capable de pressentir ce que les personnes vont dire",
  //  PARTIE 3
]
