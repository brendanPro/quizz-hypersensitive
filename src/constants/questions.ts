...
Cette solidité vous aide à prendre des décisions réfléchies et à garder la tête froide, même lorsque tout semble s’accélérer autour de vous.`,
    strength: `💡 Votre force : la maîtrise émotionnelle et la concentration
    ...
    `,
    challenge: `
      ⚖️ Votre défi : reconnaître et valoriser vos émotions
    ...
    `,
    advice: `
      🎯 Conseil de coach : cultivez l’écoute intérieure
  ...
  },
  {
    ...
    challenge: `⚖️ Votre défi, cependant, consiste à veiller à ne pas absorber inconsciemment les tensions ou les émotions collectives. 
      ...
      voient.`,
    advice: `🎯 Conseil de coach : accordez-vous régulièrement des instants de recentrage, surtout après des journées riches en interactions. 
  ...
  },
  {
    ...
    description: `Votre sensibilité est une véritable boussole intérieure — sans elle, vous auriez parfois le sentiment de dériver dans les hautes mers. Vous ressentez profondément, percevez les nuances invisibles des relations et captez les émotions ou les intentions bien avant qu’elles ne soient exprimées. 
    ...
    `,
    strength: `💡 Votre force réside dans votre empathie naturelle et votre intuition fine. Vous avez le don de vous connecter au cœur des autres, d’apporter douceur, compréhension et réconfort. Votre sensibilité vous rend profondément humain(e) et vous permet d’être un lien entre les mondes visibles et invisibles, entre la raison et le ressenti.`,
    challenge: `⚖️ Votre défi, en revanche, est d’apprendre à poser des limites émotionnelles claires pour ne pas vous laisser submerger. Votre cœur grand ouvert capte tout — les joies comme les peines — et cela peut parfois vous épuiser si vous ne filtrez pas ce qui vous appartient de ce qui vient de l’extérieur. 
    ...
    `,
    advice: `🎯 Conseil de coach : accordez-vous régulièrement des moments de retour à vous-même. L’écriture, la nature, la musique ou la création sont vos refuges naturels : des espaces où vous pouvez déposer, transformer et sublimer ce que vous ressentez.
  ...
  },
  {
    ...
    `,
    strength: `💡 Votre force réside dans votre intuition, votre profondeur et votre humanité sincère. 
    ...
    `,
    adivce: `🎯 Conseil de coach : créez dans votre vie des espaces sécurisants — des lieux, des activités ou des personnes qui vous offrent un ancrage doux et rassurant. Ce sont vos bulles d’oxygène émotionnelles, vos ports d’attache entre deux vagues.
  ...
  },
  {
    ...
    `,
    strength: `💡 Votre force réside dans votre compassion, votre empathie sincère, votre intuition fine — cette petite voix intérieure qui rarement se trompe — et votre faculté à percevoir l’invisible, les énergies, les émotions ou les vérités subtiles que d’autres ne perçoivent pas. Vous êtes un canal sensible entre le visible et l’invisible, entre la matière et l’âme.
    `,
    challenge: `⚖️ Votre défi, toutefois, est d’apprendre à canaliser cette intensité afin qu’elle vous élève plutôt qu’elle ne vous épuise. Votre cœur immense peut tout absorber, jusqu’à se saturer d’émotions qui ne sont pas les vôtres. L’objectif n’est pas de ressentir moins, mais de ressentir autrement : avec conscience, discernement et douceur.
    ...
    `,
    adivce: `🎯 Conseil de coach : entourez-vous de douceur. Offrez-vous régulièrement des espaces de calme et de ressourcement — la nature, la musique, la méditation, l’écriture, ou simplement le silence.
